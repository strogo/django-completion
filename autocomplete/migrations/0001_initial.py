...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('autocomplete_autocompleteobject', (
        ...
        db.send_create_signal('autocomplete', ['AutocompleteObject'])

        # Adding M2M table for field sites on 'AutocompleteObject'
        db.create_table('autocomplete_autocompleteobject_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('autocompleteobject', models.ForeignKey(orm['autocomplete.autocompleteobject'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('autocomplete_autocompleteobject_sites', ['autocompleteobject_id', 'site_id'])


    def backwards(self, orm):
        
        # Deleting model 'AutocompleteObject'
        db.delete_table('autocomplete_autocompleteobject')

        # Removing M2M table for field sites on 'AutocompleteObject'
        db.delete_table('autocomplete_autocompleteobject_sites')
